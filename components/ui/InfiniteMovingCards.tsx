  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[90vw] max-w-full shrink-0 rounded-2xl border border-b-0 border-slate-800 bg-linear-90 from-slate-800 to-slate-900 p-5 md:p-16 md:w-[60vw] "
            key={item.name +'_'+ idx}
          >
            <blockquote>
              <div
